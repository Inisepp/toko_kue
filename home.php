...
<body>
  ...
  <section class="hero-banner">
    <div class="hero-wrapper">
      <div class="hero-left">
        <h1 class="hero-title">Whole Cake </h1>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 pl-md-5 pl-xl-0 offset-xl-1 col-xl-5">
          ...
          <a class="button button-shadow mt-2 mt-lg-4" href="blog-details.php">More</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="bg-lightGray section-padding">
    <div class="container">
      <div class="row no-gutters">
        <div class="col-sm">
          <img class="card-img rounded-0" src="img/promo1.jpeg" alt="">
        </div>
        <div class="col-sm">
          <div class="offer-card offer-card-position">
            <h3>PROMO PSBB!</h3>
            <h3>(PAKET SPESIAL BUAT BEBEB)</h3>
            <h2>DISKON S/D 30%</h2>
          </div>
        </div>
      </div>
